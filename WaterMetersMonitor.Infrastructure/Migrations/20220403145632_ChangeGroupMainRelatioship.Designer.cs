...
namespace WaterMetersMonitor.Infrastructure.Migrations
{
    ...
    [Migration("20220403145632_ChangeGroupMainRelatioship")]
    partial class ChangeGroupMainRelatioship
    {
            ...
            modelBuilder.Entity("WaterMetersMonitor.Domain.Entities.MainWaterMeter", b =>
                {
                    b.HasOne("WaterMetersMonitor.Domain.Entities.Group", "Group")
                        .WithOne("MainWaterMeter")
                        .HasForeignKey("WaterMetersMonitor.Domain.Entities.MainWaterMeter", "GroupId")
